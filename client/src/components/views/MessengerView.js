...
const MessengerView = () => {
  ...
  const getConversation = useCallback((conversations, conservantId) => {
  ...
  }, []); // Empty dependencies array since it doesn't use any external values
  ...
  const fetchConversations = useCallback(async () => {
    ...
    setLoading(false);
  }, [user, newConservant, getConversation]);
